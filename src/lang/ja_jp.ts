export default {
    ...
    projectConfigDesc: 'プロジェクトの設定を変更します',
    projectConfigSuccess: 'プロジェクト設定が正常に更新されました',
    projectConfigError: 'プロジェクト設定の更新に失敗しました',
    projectConfigReset: 'プロジェクト設定をリセット',
    projectConfigResetDesc: 'プロジェクト設定をデフォルト値にリセットします',
    projectConfigResetSuccess: 'プロジェクト設定が正常にリセットされました',
    projectConfigResetError: 'プロジェクト設定のリセットに失敗しました',

    // 使用模式相关
    noTokenWarning: 'Tokenが設定されていません。ローカルモードでプロジェクトを作成することをお勧めします。',
    localBuildTip: 'ローカルモードでは、プロジェクトはローカルでのみ構築され、Githubにアップロードされません。',
    usageMode: '使用モード',
    localMode: 'ローカルモード',
    cloudMode: 'クラウドモード',
    localModeDesc: 'プロジェクトをローカルで構築し、Githubにアップロードしません',
    cloudModeDesc: 'プロジェクトをGithubにアップロードし、クラウドで構築します',
    selectUsageMode: '使用モードを選択してください',
    modeSelection: 'モード選択',
    localBuildStart: 'ローカルビルド開始',
    localBuildComplete: 'ローカルビルド完了'
}
