export default {
    ...
    testSuccess: 'Token可用',
    projectName: '项目名称',
    projectNamePlaceholder: '请输入英文项目名称，例如：WebAppBuilder',
    releaseBody: '请参阅下载和安装此版本的资源。',
    aboutTitle: '关于WebAppBuilder',
    aboutTips: '开源免费，打包web为跨平台APP只需几分钟',
    configToken: '请先配置Token',
    noTokenWarning: '未配置Token，将使用本地模式',
    noTokenLocalBuild: '本地模式下仅支持基础功能',
    usageMode: '使用模式',
    localMode: '本地模式',
    cloudMode: '云端模式',
    localModeDesc: '无需Token，本地打包，功能有限',
    cloudModeDesc: '需要Token，云端打包，功能完整',
    selectUsageMode: '请选择使用模式',
    modeSelection: '模式选择',
    localBuildStart: '开始本地构建',
    localBuildComplete: '本地构建完成',
    tokenOk: 'Token可用',
    ...
    delSuccess: '删除成功',
    aboutGuide:
        'WebAppBuilder开源免费，Github Token是可选的。可以将你的网页或Vue/React等项目打包成一个独立可执行程序，支持Windows/macOS/Linux系统，还支持Android/iOS移动端。有问题可以给我发送邮件：{email}。打包仅限个人使用，请勿用于传播或商业用途，打包资源会存储在你自己的Github开源仓库中，任何人都可以看得到，所以请严格遵守Github使用规范，否则后果自负。',
    followme: '关注我们',
    moreConfig: '更多配置',
    superpower: '能力演示',
    scriptFile: '脚本文件',
    ...
    initError: '初始化失败，请手动删除你的WebAppBuilder仓库重试',
    initErrorTips:
        '初始化失败，请手动删除你的WebAppBuilder仓库重试',
    single: '单例模式',
    ...
    sponsor: '赞助',
    sponsorTips:
        '如果你也喜欢我们的WebAppBuilder项目，欢迎赞助我们，我们会继续开发和维护。您的支持是我们前进的动力。赞助时请务必填写留言，以便我们收录到赞助名单中，感谢您的支持与鼓励！',
    sponsorList: '赞助名单',
